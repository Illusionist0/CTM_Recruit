	...
	<view class="container">
		...
		<view v-show="!isReach">
			<scroll-view class="scroll-view" scroll-y scroll-with-animation="true" enable-back-to-top="true" :scroll-into-view="toIndex" @scroll="scrollHandle">
				...
				<view class="city-list">
					<view class="list list-item" v-for="(item, key) of cities" :key="key" :id="key">
						...
						<view class="item" hover-class="hover" v-for="(innerItem, index) in item" :key="index" @click="selectCity(innerItem)">{{ innerItem.city }}</view>
					</view>
				</view>
			</scroll-view>
			...
			<view class="alphabet" @touchstart="touchStart" @touchend="touchEnd" @touchmove.stop="touchMove">
				<view v-for="(item, index) in alphabet" :key="item.code" @touchstart="getLetter" @touchend="setLetter" :id="item">
...
import City from '../citySelect/city.json';
export default {
	// props: {
	// 	hotcites: Array,
	// 	cities:Array,
