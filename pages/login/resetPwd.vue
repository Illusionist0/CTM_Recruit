		...
		<view class="wrapper">
			...
			<view class="input-content">
				<view class="input-item">
					...
					<input type="number" maxlength="11" disabled="true" v-model="phone" placeholder="请输入手机号码" />
				</view>
				<view class="input-item">
			...
			<button class="confirm-btn" @click="toforget">重置</button>
		</view>
	</view>
</template>
...
export default {
	...
	methods: {
		...
		async toforget(){
			...
			let params = {phone: this.phone,password: this.passwords,code: this.code}
			let res = await this.$apis.resetPwd(params);
			if (res) {
