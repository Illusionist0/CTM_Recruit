<template>
	<view class="content reg-page">
		<view class="column padding-20">
			...
			<view class="r-top">
				<textarea :style="{height:height+'px'}" :adjust-position="false" :maxlength="len" placeholder-style="color:rgba(153,153,153,1);" v-model="content" :placeholder="placeholder" />
				<view class="r-top-t">
				 	<view></view>
